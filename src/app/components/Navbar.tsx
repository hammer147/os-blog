    ...
    <nav className='sticky top-0 z-10 bg-slate-600 p-4 drop-shadow-xl'>
      <div className='max-w-5xl mx-auto flex flex-col justify-between sm:flex-row md:px-6'>
        ...
        <div className='flex flex-row justify-center gap-4 align-middle text-4xl text-white sm:justify-evenly lg:text-5xl'>
          <Link className='text-white/90 hover:text-white' href='https://learn.microsoft.com/en-us/office/dev/scripts/overview/excel'>
            <FaMicrosoft />
          </Link>
          <Link
          ...
          <Link className='text-white/90 hover:text-white' href='https://github.com/search?q=officescripts&type=repositories'>
            <FaGithub />
          </Link>
          <Link className='text-white/90 hover:text-white' href='https://twitter.com/hashtag/OfficeScripts'>
            <FaTwitter />
          </Link>
        </div>
      </div>
